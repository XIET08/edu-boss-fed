  ...
  <div class="container">
    <div class="setting">
      <div class="input-control">
        <label for="timeout"
          >请求过期时间（构造参数 timeout, 默认 60000）:</label
        >
        <input
          type="text"
          id="timeout"
          v-model="timeout"
          placeholder="输入过期时间, 单位毫秒"
        />
      </div>

      <div class="input-control">
        <label for="partSize"
          >分片大小（构造参数 partSize, 默认 1048576）:</label
        >
        <input
          type="text"
          class="form-control"
          id="partSize"
          v-model="partSize"
          placeholder="输入分片大小, 单位bit, 最小100k"
        />
      </div>
      ...
      <div class="input-control">
        ...
        <input
          ...
          id="parallel"
          v-model="parallel"
          placeholder="输入并行上传分片个数, 默认为5"
        />
      </div>

      <div class="input-control">
        <label for="retryCount"
          >网络失败重试次数（构造参数 retryCount, 默认 3）:</label
        >
        <input
          type="text"
          class="form-control"
          id="retryCount"
          v-model="retryCount"
          placeholder="输入网络失败重试次数, 默认为3"
        />
      </div>

      <div class="input-control">
        <label for="retryDuration"
          >网络失败重试间隔（构造参数 retryDuration, 默认 2）:</label
        >
        <input
          type="text"
          class="form-control"
          id="retryDuration"
          v-model="retryDuration"
      ...
      <div class="input-control">
        ...
        集成产品后需要使用用户自己的账号ID,
        <a
          href="https://help.aliyun.com/knowledge_detail/37196.html "
          target="_blank"
          >如何获取帐号ID</a
        >
      </div>
